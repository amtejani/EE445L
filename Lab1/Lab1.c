...
// Possible main program to test the lab 1
// Runs on TM4C123
// Uses ST7735.c LCD.
...
void displayCoverPage(void);
void displayDecOut(void);
void displayBinOut(void);
...
void displayCoverPage() {
	...
	printf("Lab 1\r\rHakuna Matata\r\rAli Tejani\rCaroline Yao\r\ramt3639\rchy253\r");
	Pause();
}

// display output of ST7735_sDecOut3 with sample input
void displayDecOut() {
	uint32_t i;
	ST7735_FillScreen(ST7735_BLACK); 
	ST7735_SetCursor(0,0);
	printf("ST7735_sDecOut3\rExpected  Actual\r");
	for(i=0; i<13; i++){
...
// display output of ST7735_uBinOut8 with sample input
void displayBinOut() {
	uint32_t i;
	ST7735_FillScreen(0);  // set screen to black
	ST7735_SetCursor(0,0);
	printf("ST7735_uBinOut8\rExpected  Actual\r");
	for(i=0; i<14; i++){
...
// display output of ST7735_XYplotInit and ST7735_XYplot with sample input
void displayCircle() {
	ST7735_XYplotInit("XYplot \rCircle",-2500, 2500, -2500, 2500);
...
// display output of ST7735_XYplotInit and ST7735_XYplot with sample input
void displayStar() {
	ST7735_XYplotInit("XYplot \rStar- upper right",-450, 150, -400, 200);
